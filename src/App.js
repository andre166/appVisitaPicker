...
function App() {
  ...
  const gerarCarros = () => {
    let response = [
      ...
      // itb1
      { id: 1, lng: -42.94753874745315, lat: -22.79139388319243 , cercaDeAtuacao: 'Área 01 - Manillha - ITB 01', tipo: 'supervisor', nome:'supervisor - ITB 01' },
      { id: 2, lng: -42.92069930546788, lat: -22.78543895098248 , cercaDeAtuacao: 'Área 01 - Manillha - ITB 01' , tipo: 'manutencao', nome:'manutenção - ITB 01' },
      { id: 3, lng: -42.90126958830669, lat: -22.77985145685625 , cercaDeAtuacao: 'Área 01 - Manillha - ITB 01' , tipo: 'instalacao', nome:'inst - ITB 01' },
      // itb2
      { id: 4, lng: -42.8916183274623, lat: -22.77483568107419 , cercaDeAtuacao: 'área 02 - São joaquim e Joaquim de Oliveira - ITB 02' , tipo: 'supervisor', nome:'supervisor - ITB 02' },
      { id: 5, lng: -42.90285230447015, lat: -22.78876168943736 , cercaDeAtuacao: 'área 02 - São joaquim e Joaquim de Oliveira - ITB 02' , tipo: 'manutencao', nome:'manutenção - ITB 02' },
      { id: 6, lng: -42.89887863355187, lat: -22.7287281654507 , cercaDeAtuacao: 'área 02 - São joaquim e Joaquim de Oliveira - ITB 02' , tipo: 'instalacao', nome:'instalação - ITB 02' },
      // itb3
      { id: 7, lng: -42.90088601711899, lat: -22.71833948103525 , cercaDeAtuacao: 'ÁREA 03 - ITB 03' , tipo: 'supervisor', nome:'supervisor - ITB 03' },
      { id: 8, lng: -42.82787236652075, lat: -22.76489807864087 , cercaDeAtuacao: 'ÁREA 03 - ITB 03' , tipo: 'manutencao', nome:'manutenção - ITB 03' },
      { id: 9, lng: -42.88437383993017, lat: -22.72968842403092 , cercaDeAtuacao: 'ÁREA 03 - ITB 03' , tipo: 'instalacao', nome:'instalação - ITB 03' },
      // itb4
      { id: 10, lng: -42.82498142399804, lat: -22.70773623034828 , cercaDeAtuacao: 'ÁREA 04 - ITB 04' , tipo: 'supervisor', nome:'supervisor - ITB 04' },
      { id: 11, lng: -42.82155921977381, lat: -22.70904054919757 , cercaDeAtuacao: 'ÁREA 04 - ITB 04' , tipo: 'manutencao', nome:'manutenção - ITB 04' },
      { id: 12, lng: -42.88002710970934, lat: -22.79116365388647 , cercaDeAtuacao: 'ÁREA 04 - ITB 04' , tipo: 'instalacao', nome:'instalação - ITB 04' },
      // itb5
      { id: 13, lng: -42.88434871406977, lat: -22.78825137671154 , cercaDeAtuacao: 'ÁREA 05 - ITB 05' , tipo: 'supervisor', nome:'supervisor - ITB 05' },
      { id: 14, lng: -42.87253894014584, lat: -22.79266008944926 , cercaDeAtuacao: 'ÁREA 05 - ITB 05' , tipo: 'manutencao', nome:'manutenção - ITB 05' },
      { id: 15, lng: -42.90664743710982, lat: -22.73193761991607 , cercaDeAtuacao: 'ÁREA 05 - ITB 05' , tipo: 'instalacao', nome:'instalação - ITB 05' },
      // itb6
      { id: 16, lng: -42.91165644349839, lat: -22.72179490425665 , cercaDeAtuacao: 'ÁREA 06 - ITB 06' , tipo: 'supervisor', nome:'supervisor - ITB 06' },
      { id: 17, lng: -42.83650697273852, lat: -22.78011789703801 , cercaDeAtuacao: 'ÁREA 06 - ITB 06' , tipo: 'manutencao', nome:'manutenção - ITB 06' },
      { id: 18, lng: -42.82342534831196, lat: -22.75655963101576 , cercaDeAtuacao: 'ÁREA 06 - ITB 06' , tipo: 'instalacao', nome:'instalação - ITB 06' },
      // itb7
      { id: 19, lng: -42.8589937237037, lat: -22.69848169109618 , cercaDeAtuacao: 'ÁREA 07 - ITB 07' , tipo: 'supervisor', nome:'supervisor - ITB 07' },
      { id: 20, lng: -42.84955991503653, lat: -22.69665231613408 , cercaDeAtuacao: 'ÁREA 07 - ITB 07' , tipo: 'manutencao', nome:'manutenção - ITB 07' },
      { id: 21, lng: -42.86226070046544, lat: -22.69213797637705 , cercaDeAtuacao: 'ÁREA 07 - ITB 07' , tipo: 'instalacao', nome:'instalação - ITB 07' },
